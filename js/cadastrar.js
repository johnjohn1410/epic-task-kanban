document
    .querySelector("#botao-cadastrar").addEventListener("click", () => {
    ...
    const tarefa = {
        ...
        descricao: form.Descrição.value,
...
function validar(tarefa){
    ...
    if (tarefa.descricao.trim() == "" || tarefa.descricao.length < 10){
        document.querySelector("#Descrição").classList.add("is-error")
        document.querySelector("#Descrição-erro").innerText = "a descrição deve ter pelo menos 10 caracteres"
    }
